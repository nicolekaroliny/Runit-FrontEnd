      ...
      <div className="min-h-screen bg-white flex flex-col p-0">
        ...
        <header className="w-full relative py-6 h-24 flex items-center rounded-b-3xl z-50" style={{ background: '#20017B', color: '#fff' }}>
          <div className="w-full flex items-center justify-between px-8">
            ...
            <nav className="flex gap-8 items-center text-2xl font-bold">
              ...
              <a
                href="/sobre-nos"
                className={`hover:underline px-2 py-1 rounded transition-colors duration-200 font-extrabold ${pathname === '/sobre-nos' ? 'bg-white text-[#20017B] shadow' : 'text-white'}`}
              >
                Sobre Nós
              </a>
              <a
                href="#contato"
                className={`hover:underline px-2 py-1 rounded transition-colors duration-200 font-extrabold ${pathname === '#contato' ? 'bg-white text-[#20017B] shadow' : 'text-white'}`}
              >
                Contato
              </a>
            </nav>
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3 w-full relative z-10">
            <h2 className="text-5xl font-extrabold text-black drop-shadow-lg text-center" style={{ textShadow: '2px 2px 8px rgba(0,0,0,0.3)' }}>
